import { GET_DOGS, GET_TEMPERAMENTS, SEARCH_DOGS, SET_LOADING, SET_PAGE, SET_TOTAL_PAGE, FILTER_BY_ORIGIN, FILTER_BY_TEMPERAMENT, SORT_ORDER, UPDATE_ORDER, CLEAN_FILTER, SET_CLEAN } from "./actionType";
